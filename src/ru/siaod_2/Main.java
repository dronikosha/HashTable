...
class Data implements Serializable  {
    ...
    boolean Pdel;
    boolean Pins;
    // 1) Признак удаленной ячейки, вместо обнуления ячейки, я буду выставлять ей значение True у признака,
    // и при поиске элемента я буду проверять данный признак.
    // 2) Признак пустой ячейки
